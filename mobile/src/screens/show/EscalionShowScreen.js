...
export default function EscalionShowScreen({
  ...
  const handleMastTouch = (event) => {
    const x = event.nativeEvent.locationX
    const part = selectorWidth.current / 4
    const mast = Math.max(0, Math.min(3, Math.floor(x / part)))
  ...
  // const heroCollapseShift = scrollY.interpolate({
  //   inputRange: [0, 190],
  //   outputRange: [0, -118],
  //   extrapolate: 'clamp',
  // })
  ...
  const topHeaderOpacity = scrollY.interpolate({
    inputRange: [TITLE_HEIGHT / 2, TITLE_HEIGHT],
    outputRange: [0, 1],
    extrapolate: 'clamp',
  })
  ...
  return (
    <View style={[styles.screen, { paddingBottom: Math.max(bottomInset, 8) }]}>
      {page === 'general' && (
        <>
          <Animated.View
            pointerEvents="none"
          ...
          >
            ...
            <Animated.View
              style={[
                styles.cardsStack,
                // { transform: [{ translateY: heroCollapseShift }] },
              ]}
            >
                ...
                <Row
                  ...
                  onPressIn={(event) => {
                    selectorWidth.current =
                      event.nativeEvent.locationX * 2 || 320
                  }}
                  noBorder
                />
              </View>
      ...
      {page === 'connections' && (
        <>
          <Animated.View
            pointerEvents="none"
            style={styles.smallHeaderOverlayStatic}
          >
            <Text style={styles.headerTitleSmall}>Подключения</Text>
          ...
          >
            <View style={styles.card}>
              ...
              <Row
                title="Bluetooth"
                subtitle="Включено"
                icon={<IconBall name="bluetooth" lib="mc" color="#317dff" />}
              />
              <Row
              ...
              <Row
                title="Режим полета"
                subtitle="Выключено"
                icon={<IconBall name="airplane" color="#4f5568" />}
                noBorder
              />
            </View>
            <Pressable
      ...
      {page === 'wifi' && (
        <>
          <Animated.View
            ...
            style={styles.smallHeaderOverlayStatic}
          >
            <Text style={styles.headerTitleSmall}>Wi-Fi</Text>
            <View style={styles.searchWrapSmall}>
              <Ionicons name="search" size={24} color="#f2f5fb" />
            </View>
          </Animated.View>
